 ...
 rounded-lg p-4 border border-blue-200">
          ...
          <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            <button
              ...
              className="px-6 py-3  bg-gradient-to-br from-orange-400 via-red-500 to-red-600 hover:from-red-700 hover:to-red-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg font-bold transition-colors shadow-lg"
            >
              Guardar Cambios
            </button>
          </div>
