        ...
        <div className="p-6">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-lg p-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-orange-600 font-bold text-lg">{totalAvailableStock} unidades</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-3 py-1 bg-gradient-to-br from-orange-400 via-red-500 to-red-500 rounded-lg text-sm text-white"
              >
                Auto-distribuir
              </button>
            </div>
          ...
          <div className="flex items-center justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button
              ...
              className="px-6 py-3  bg-gradient-to-br from-orange-400 via-red-500 to-red-600 hover:from-orange-600 hover:to-orange-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg font-bold transition-colors shadow-lg"
            >
