    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card title="Taras Más Utilizadas">
            <div className="space-y-3">
              {taras.slice(0, 5).map(tara => (
                <div key={tara.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <div className="font-medium text-gray-900">{tara.nombre}</div>
                    <div className="text-sm text-gray-500">
                      Peso: {tara.peso.toFixed(3)} kg
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-xs text-gray-500">
                      {new Date(tara.created_at).toLocaleDateString('es-MX')}
                    </div>
                  </div>
                </div>
              ))}
